...
public class PolicyEnforcementServiceTests extends CreateValidatePES{
	...
	public PolicyEnforcementServiceTests(String policyId, String request_id, String testcaseNumber, String testcaseDesc) {
	...
	private void validateOutput(VerifyAccessRequest request, VerifyAccessResponse response, String request_id){
		...
		if(policies.contains("AUTHN")){
			...
			for(SubjectType subjectType : response.getAuthenticatedSubject()) {
				System.out.println("Value : " + subjectType.getValue() + "Domain : " + subjectType.getDomain());
			}
		}
