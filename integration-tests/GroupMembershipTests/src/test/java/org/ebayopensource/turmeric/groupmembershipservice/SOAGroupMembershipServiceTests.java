...
public class SOAGroupMembershipServiceTests extends CreateValidateSG {
	...
	private static final String s_PropFilePath = "SOAGroupMembershipServiceTests.properties";
	private static Class<SOAGroupMembershipServiceTests> className = SOAGroupMembershipServiceTests.class;
	...
	public SOAGroupMembershipServiceTests(String policyId, String request_id, String testcaseNumber, String testcaseDesc) {
	...
	public static Collection loadInputData() throws IOException {
		...
		InputStream inputStream = className.getResourceAsStream(s_PropFilePath);
			...
			props.getProperty("total_testcases");
