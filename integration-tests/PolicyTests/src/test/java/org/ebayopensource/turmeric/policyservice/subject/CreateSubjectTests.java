...
public class CreateSubjectTests{
	...
	private static final String s_PropFilePath = "CreateSubjectTests.properties";
	...
	public CreateSubjectTests(String testCaseName,String inputData, String expectedResult) {
	...
	public void testCreateSubjects() throws Exception {
		...
		try {
			...
			response = PolicyServiceTestHelper.getInstance().createSubjects(
	...
	public static Collection loadInputData() {
		...
		InputStream inputStream = CreateSubjectTests.class.getResourceAsStream(s_PropFilePath);
		try {
