...
/**
 * The class for policy searching exceptions.
 * 
 * @author rpallikonda
 * 
 */
public class PolicyFinderException extends PolicyProviderException {
	 ...
	 */
	public PolicyFinderException(Category category, String entityType,
			String errorMsg) {
