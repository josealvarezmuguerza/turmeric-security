...
/**
 * The class for policy deletion exceptions.
 * 
 */
public class PolicyDeleteException extends PolicyProviderException {
	 ...
	 *            detailed message
	 */
	public PolicyDeleteException(Category category, String entityType,
			String errorMsg) {
