...
package org.ebayopensource.turmeric.services.authorizationservice.intf.gen;
...
import org.ebayopensource.turmeric.services.authorizationservice.intf.AsyncAuthorizationService;
 ...
 * 
 */
public class BaseAuthorizationServiceConsumer {

    private URL m_serviceLocation = null;
    private final static String SVC_ADMIN_NAME = "AuthorizationService";
    private String m_clientName = "AuthorizationService";
    private String m_environment;
    private AsyncAuthorizationService m_proxy = null;
    private String m_authToken = null;
    private Cookie[] m_cookies;
    private Service m_service = null;

    public BaseAuthorizationServiceConsumer() {
    }

    public BaseAuthorizationServiceConsumer(String clientName)
    ...
    public BaseAuthorizationServiceConsumer(String clientName, String environment)
        throws ServiceException
    {
        if (environment == null) {
    ...
    protected AsyncAuthorizationService getProxy()
        throws ServiceException
    {
        m_service = getService();
    ...
    public Future<?> authorizeAsync(AuthorizeRequestType param0, AsyncHandler<AuthorizeResponseType> param1) {
        Future<?> result = null;
        try {
            m_proxy = getProxy();
        ...
        result = m_proxy.authorizeAsync(param0, param1);
        return result;
    }

    public Response<AuthorizeResponseType> authorizeAsync(AuthorizeRequestType param0) {
        Response<AuthorizeResponseType> result = null;
        try {
            m_proxy = getProxy();
        } catch (ServiceException serviceException) {
            throw ServiceRuntimeException.wrap(serviceException);
        }
        result = m_proxy.authorizeAsync(param0);
        return result;
    }
    ...
    public AuthorizeResponseType authorize(AuthorizeRequestType param0) {
        ...
        result = m_proxy.authorize(param0);
        return result;
    }
